          ...
          <CardContent className="p-4 space-y-4">
            {isInstalled ? (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-speede-red">{isRot ? 'Download App to Phone' : isTh ? 'ดาวน์โหลดแอปสิ' : 'Install SpeedE App'}</p>
                    <p className="text-xs text-gray-500">{isRot ? 'Pin SpeedE to your home screen for easy spawn-in' : isTh ? 'ติดตั้งแอปลงบนหน้าจอหลักเพื่อความสะดวกและรวดเร็ว' : 'Add SpeedE to your home screen for quick access.'}</p>
                  </div>
                </div>
              </button>
            ) : isIOS ? (
              ...
              <div className="p-3 text-center">
                <p className="font-medium text-sm text-gray-500">{isRot ? 'Open in Chrome/Safari to install PWA' : isTh ? 'เปิดแอปผ่าน Google Chrome บนมือถือเพื่อปุ่มดาวน์โหลด' : 'To install this app on your phone, open it in Chrome or Safari.'}</p>
              </div>
            )}
          </CardContent>
        </Card>
